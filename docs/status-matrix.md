...
| LAN Ailish ranged combat | LAN arena | PARTIAL | EXPERIMENTAL | CODE_EXISTS, POLICY_TESTED, EXACT_IMAGE_TESTED, LIVE_PROVEN | Owner-confirmed staff smoothing, wheel cycling, and Shock Staff shot/recharge in the LA26 weapon-presentation checkpoint | Host-side swap turn, midpoint equipment timing, all-weapon/hold cadence, full projectile consequences, and native-shot disconnect behavior remain incomplete | High | Preserve bounded native shot/recharge acceptance; verify remaining weapon and lifecycle cases |
| LAN skills and Spirit | LAN arena | PARTIAL | RESEARCH-ONLY | CODE_EXISTS, POLICY_TESTED, PROTOCOL_TESTED, EXACT_IMAGE_TESTED, LIVE_PROVEN, UNVERIFIED_DIRTY_WORK | Accepted LA23 opening/orb checkpoint retained; experimental LA24 adds cast-independent target-owned Boost visuals and native-input freshness policy; see LAN guide's LA24 follow-up | Boost visual/expiry acceptance, forced-running/camera symptoms, other status assets, generic hit provenance, two-machine behavior and reconnect remain incomplete | Highest current work | Verify Moon Wolf glows and movement during casts; preserve accepted opening playback and lifecycle |
