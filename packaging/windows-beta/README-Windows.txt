...
3. Double-click "Launch SudekiMP.cmd" inside the SudekiMP folder.

Do not double-click SudekiMP.Launcher.exe by itself. It is a console loader
which requires the game and DLL paths; the supplied .cmd file passes those
paths and leaves the window open if validation fails.
