...
int main(void) {
    ...
    CHECK(SudekiMpLanArenaPacketAllowedForRole(
        SUDEKIMP_LAN_ARENA_ROLE_HOST_TAL, SUDEKIMP_LAN_ARENA_PACKET_INPUT));
    CHECK(!SudekiMpLanArenaPacketAllowedForRole(
        SUDEKIMP_LAN_ARENA_ROLE_HOST_TAL, SUDEKIMP_LAN_ARENA_PACKET_SNAPSHOT));
    CHECK(SudekiMpLanArenaPacketAllowedForRole(
        SUDEKIMP_LAN_ARENA_ROLE_CLIENT_AILISH, SUDEKIMP_LAN_ARENA_PACKET_SNAPSHOT));
    CHECK(!SudekiMpLanArenaPacketAllowedForRole(
        SUDEKIMP_LAN_ARENA_ROLE_CLIENT_AILISH, SUDEKIMP_LAN_ARENA_PACKET_INPUT));
    CHECK(SudekiMpLanArenaPacketAllowedForRole(
        SUDEKIMP_LAN_ARENA_ROLE_HOST_TAL, SUDEKIMP_LAN_ARENA_PACKET_KEEPALIVE));
    CHECK(SudekiMpLanArenaPacketAllowedForRole(
        SUDEKIMP_LAN_ARENA_ROLE_CLIENT_AILISH, SUDEKIMP_LAN_ARENA_PACKET_KEEPALIVE));
